...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    console.log('Selected payment method:', method);  // Check method value
    ...
    try {
      ...
      switch (method) {
        ...
        case 'cod':
          console.log("cod method selected")
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-2 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('cod')} className='flex items-centergap-3 border py-2 px-3 cursor-pointer '>
